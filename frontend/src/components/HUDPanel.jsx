...
export default function HUDPanel() {
  ...
  return (
    <div className="absolute right-4 top-4 z-40 w-80 max-h-[calc(100vh-7rem)] rounded-lg border border-primary-container bg-background/95 backdrop-blur-xl p-5 shadow-[0_0_30px_rgba(255,92,0,0.25)] flex flex-col group overflow-hidden">
      ...
      {/* Header */}
      <header className="flex justify-between items-center mb-5 pb-2 border-b border-outline-variant/30 pr-6 flex-shrink-0">
          ...
          return (
            <div 
              ...
              className={`p-2.5 rounded border transition-all ${
                isSelected 
                  ? 'border-primary-container/50 bg-primary-container/5 shadow-[0_0_8px_rgba(255,92,0,0.15)]' 
                  : 'border-outline-variant/20 bg-surface/30 hover:border-outline-variant/50'
              }`}
            >
      ...
      {/* Panel Footer */}
      <div className="mt-6 pt-3 border-t border-outline-variant/20 flex justify-between text-[10px] font-mono text-outline/40 flex-shrink-0">
